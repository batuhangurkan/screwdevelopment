...
//------------- CONFIG
global.config = {
  "token": "ODU4MDk5Nzg3MDc2NDY4NzU3.YNZNsw.7z31XCdmPuMdoXEW4clrnkQ39g4",
  "clientid": "858099787076468757",
  "secret": "CVPfowk_rmg1k_zH1Fm7lWl0230DSZLy",
  "callback": "",
  "site": ""
}
//------------- CONFIG
...
client.on("ready", () => {
  ...
  client.user.setActivity("Screw Development", { type: "WATCHING" });
  console.log("screwdevelopment.org is online.");
})
//------------- CLIENT
